...
$sql = $link->prepare("SELECT COUNT(*) FROM `order` WHERE KlantenID = :KLANTENID AND isBesteld = 0");
$sql->bindValue(':KLANTENID', $user['KlantenID']);
$sql->execute();
$orders0count = $sql->fetchColumn();
        ...
        <table class="centertable">
            ...
            <tr>
                ...
                <td class="edituser">
                    ...
                    <a href="editUser.php" style="color: dodgerblue;"><img src="images/editTRANS.png" alt="pas gebruikersgegevens aan"/></a>
                </td>
            </tr>
        </table>
        <br>
